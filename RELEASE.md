...
```shell
docker build -t geoserver-docker.osgeo.org/geoserver:2.26.1 .
```
...
```shell
docker push geoserver-docker.osgeo.org/geoserver:2.26.1
```
...
`./release.sh build 2.26.1`

`./release.sh publish 2.26.1`

`./release.sh buildandpublish 2.26.1`
